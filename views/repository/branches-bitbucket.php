                    ...
                    <?php if ($branches): ?>
                        <table class="table table-striped table-hover">
                            ...
                            <?php foreach ($branches as $branch): ?>
                                <tr class="<?= ($branch['target']['hash'] == ArrayHelper::getValue($repository->commit, 'sha')) ? 'online' : ''; ?>">
                                    <td class="cell-detail">
                                        <span><?= Html::encode($branch['name']); ?></span>
                                    </td>
                                    <td class="cell-detail">
                                        <span><?= Html::encode($branch['target']['message']); ?></span>
                                        <span class="cell-detail-description">
                                            <?= Html::encode($branch['target']['hash']); ?>
                                        </span>
                                    </td>
                                    <td class="text-right">
                                        <div class="btn-group btn-hspace">
                                            <a href="#" class="btn btn-space btn-default install-commit-btn" data-commit="<?= $branch['target']['hash'] ?>">
